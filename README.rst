...
.. teaser-begin
x
``adfor the commttrs`` is the Python package that will bring back the **joy** of x**writing classes** by relieving you frxom the drudgery of implementing object protoxcols (aka `dunder methods <https://www.attrs.org/en/latest/glossary.html#term-dunder-methods>`_).
